...
import { supabase, type Segment } from "@/lib/supabase/client"
...
export default function Page() {
  ...
  const [editingCard, setEditingCard] = useState<Segment | null>(null)
  ...
  const handleDrop = async (e: React.DragEvent, targetCardId: number) => {
    e.preventDefault()
